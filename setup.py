...
setup(
    name='sopel_modules.trafikverket',
    version='0.1.0',
    description='A Sopel module which pulls information from the open API provided by swedish Trafikverket',
    long_description=readme + '\n\n' + history,
    author='Mikael Söder',
    author_email='mik@elsoder.se',
    url='http://github.com/Misoder/sopel-trafikverket',
